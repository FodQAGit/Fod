<tr valign="top">
    <td colspan="2">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" id="utilities">
            <tr valign="middle">
                <td align="right"><a href="<s:url value="/"/>">Bank Home</a> | <a href="<s:url action="../FindLocations"/>">Find Locations</a> | <a href="<s:url value="/"/>">Contact
...
<%--                <td><a href="" title="">Make Payments</a></td> --%>
                ...
                <td><a href="<s:url value="/auth/ChangePass.action" includeParams="none"/>" title="">Change Pass</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
