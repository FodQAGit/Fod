    ...
    <tr valign="mtop">
        <td colspan="2">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr valign="middle">
                    <td id="utilities" align="right"><a href="<s:url value="/"/>">Bank Home</a> | <a href="<s:url action="/FindLocations"/>">Find Locations</a> | <a href="<s:url value="/"/>">Contact Us</a> | <a href="<s:url value="/"/>">Site Map</a>&nbsp;</td>
